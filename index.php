    ...
    <div class="video-overlay">
      <div class="container" style="max-width: 90%;">
        ...
        <section id="inicio" class="my-5">
          ...
          <a href="bases/Bases_CECyBOT_2025.pdf" target="_blank" class="btn btn-secondary btn-lg"> <img src="admin/assets/img/logo.png" alt="CECYBOT 2025" width="50" height="100">  DESCARGA AQUI LAS BASES DEL EVENTO  </a>       
        </section>
