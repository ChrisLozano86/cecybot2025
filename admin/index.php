...
<div class="wrapper">
 ...
 -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="modules/registros/index.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content" id="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <img src="assets/img/logo.png" alt="CECYBOT" class="img-fluid d-block mx-auto" style="width: 45%;">
          </div>
          <!-- /.col-12 -->
        </div>
        <!-- /.row -->
  ...
  <footer class="main-footer text-center">
    ...
    <!-- Default to the left -->
    <p>Copyright &copy; <?php echo date('Y') ?>. Todos los derechos reservados | CECYBOT</p>
  </footer>
</div>
<!-- ./wrapper -->
